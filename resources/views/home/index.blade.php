    ...
    <nav class="navbar navbar-expand-lg navbar fixed-top  navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="#" class="language" rel="it-IT"><img src="images/italy.ico" class="flag"
                                                                  alt="Italiano"></a>
                    <a href="index.blade.php" class="language" rel="en-En"><img src="images/english.ico" class="flag"
                                                                                alt="English"></a>
                </li>
            </ul>
        </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 img-fluid img-slider"
                     src="https://afamilycdn.com/2019/12/1/photo-1575164080086-1575164080095165449684.png"
                     alt="First slide">
            ...
            <div class="carousel-item">
                <img class="d-block w-100 img-fluid img-slider"
                     src="https://duyendangvietnam.net.vn/public/uploads/files/3(307).jpg" alt="Second slide">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img class="d-block w-100 img-fluid img-slider"
                     src="https://www.disneycooking.com/wp-content/uploads/2018/12/mon-khai-vi-dai-tiec.jpg"
                     alt="Third slide">
                <div class="carousel-caption">
...
<div class="row bg-light">
        ...
        <div class="card">
            <a href="#">
                <img class="card-img-top img-fluid "
                     src="http://file.hstatic.net/200000301004/article/mon-ngon-tu-tom-bnafoods_d7dbda5764c84a58906b79769a0d5c30_1024x1024.jpg">
            </a>
            <div class="card-body">
                <h5 class="card-title">~ Top View ~</h5>
                <ul class="list-group list-group-flush">
                    @foreach($viewsFoods as $food)
    ...
    <div class="col-md-3" data-aos="slide-up">
        <div class="card">
            <a href="#">
                <img class="card-img-top img-fluid"
                     src="https://tapchinhabep.net/wp-content/uploads/2019/04/32416935-moscow-russia-october-6-2014-mcdonald-s-food-mcdonald-s-corporation-is-the-world-s-largest-chain-of--e1555923510899.jpg">
            </a>
            <div class="card-body">
...
<div class="search">
    <div class="form-inline my-2 my-lg-0">
        <input class="form-control mr-sm-2" id="search-food" type="search" placeholder="Tìm đồ ăn">
        <ul id="list-food-search"
            style="position: absolute;z-index: 1000;width: 221px;margin-top: 221px"
            class="list-group"></ul>
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
    </div>
</div>
<div class="row bg-light food-list">
    @foreach($foods as $food)
        <div class="col-md-3" data-aos="slide-up">
            <div class="card">
                <div class="card-header btn" data-toggle="collapse" aria-expanded="true"
                     data-parent="#myaccordion">
                    {{$food->name}}
                </div>
                <div class="card-body collapse show" data-toggle="collapse" aria-expanded="false">
                    <img width="100%" src="{{asset('storage/'.$food->image)}}">
                </div>
            </div>
        </div>
<<<<<<< HEAD
...
<div class="row bg-light" id="food-item">
</div>
...
<div class="row footer bg-light">
    <div class="col">
        <p class="text-center">Follow us: <a class="social-icon" href="https://www.facebook.com/rubiktechnologiesShpk/"><i
                    class="fab fa-facebook"></i></a> <a class="social-icon"
                                                        href="https://www.instagram.com/rubiktechnologies/"><i
...
<footer class="container">
    <div class="row only-mobile">
        ...
        <div class="col-6">
            <a class="btn btn-success btn-block text-center" href="https://api.whatsapp.com/send?phone=+390000000"><i
