...
{{--                </li>--}}
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100 img-fluid img-slider" src="https://duyendangvietnam.net.vn/public/uploads/files/3(307).jpg" alt="Third slide">
                <div class="carousel-caption">
...
<div class="row bg-light">
    ...
    <div class="card">
        ...
        <div class="card-body collapse"  data-toggle="collapse"  aria-expanded="false" id="noidungcard3">
            <button aria-expanded="false"  class="btn btn-outline-danger"
                    data-toggle="collapse" data-target="#boxnoidung">Bấm vào đây</button>
        </div>
    </div>
 </div>
    ...
    <div class="row footer bg-light">
        <div class="col">
            <p class="text-center">Follow us: <a class="social-icon" href="https://www.facebook.com/xauzai.deoyeuduocai"><i class="fab fa-facebook"></i></a> <a class="social-icon" href="https://www.instagram.com/rubiktechnologies/"><i class="fab fa-instagram"></i></a></p>
        </div>
        <div class="col">
...
<script type="text/javascript" src="{{asset('smooth-scroll.js')}}"></script>
